    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                {
                    // Found in dictionary or controller names. Create an error result.
                    result = IdentityResult.Failed("Name " + model.UserName + " is already taken.");
                }
                else
                {
                    ...
                    if (result.Succeeded)
                    {
                        ...
                        await UserManager.SendEmailAsync(user.Id, "Confirm your account", 
                            ...
                            "<p>If thatlink doesn't work for you, please coy and paste the following URL into your browser: " + callbackUrl + "</p>");
        ...
        // egd
        // Check to make sure requested username is not in dictionary.txt or an already used controller name.
        // We reserve dictionary.txt names for future use as controllers names.
        // Routing would break is user's names were the same as controler names.
        // dictionary.txt contains a list of comon nouns. We also check for plural nouns.
        private bool UserNameIsValid(string userName)
        {
            ...
            if (controllerNames.Contains(userName) || controllerNames.Contains(pluralUserName))
            {
                return false;
            }
        ...
        public async Task<ActionResult> ConfirmEmail(string userId, string code)
        {
            ...
            // If the confirmation succeeded, sign in the user and redirect to the thank you/create project page
            if (result.Succeeded)
            {
                // Add them to the "User" role
                UserManager.AddToRole(userId, Role.User.ToString());

                SignInManager.SignIn(user, false, false);

                return View("ConfirmEmailCreateProject");
            }

            // In all other cases, redirect to an error page
            return View("Error");

            //// TODO: ask them if they want to create their own project here.
